import { BookDataType } from "@/app/types/types";

export const data: BookDataType = [
  {
    id: 1,
  ...
  },
  {
    ...
    description: `Hardback, 8vo black cloth boards, silver titles, first edition, 1st impression, , 285pp. Good +/Good +. Book has been read, block edges have some dusting, spine has some creasing, pages clean. Dustwrapper (now protected) has some shelfwear, spine colour faded, some creasing to edges. A Discworld novel.`,
    price: "£8",
    onSale: true,
    draft: false,
  },
